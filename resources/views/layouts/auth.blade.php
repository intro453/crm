...
<body class="@yield('body-class', 'vertical-layout vertical-menu-modern blank-page navbar-floating footer-static')" data-open="click" data-menu="vertical-menu-modern" data-col="blank-page">
    <!-- BEGIN: Content-->
                    ...
                    <div class="auth-inner row m-0">
                                ...
                                <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <g id="Artboard" transform="translate(-400.000000, -178.000000)">
                                        <g id="Group" transform="translate(400.000000, 178.000000)">
                                            <path class="text-primary" id="Path" d="M0,0 L39.1816085,0 L69.3453773,32.2519224 L101.428699,0 L138.784583,0 L138.784199,29.8015838 C137.958931,37.3510206 135.784352,42.5567762 132.260463,45.4188507 C128.736573,48.2809251 112.33867,64.5239941 83.0667527,94.1480575 L56.2750821,94.1480575 L6.71554594,44.4188507 C2.46876683,39.9813776 0.345377275,35.1089553 0.345377275,29.8015838 C0.345377275,24.4942122 0.230251516,14.560351 0,0 Z" style="fill: currentColor"></path>
                                            ...
                                            <polygon id="Path-2" fill="#000000" opacity="0.05" points="69.3922914 32.4202615 32.8435758 70.5039241 54.0490008 16.1851325"></polygon>
                                            <polygon id="Path-21" fill="#000000" opacity="0.1" points="69.3922914 32.4202615 32.8435758 70.5039241 58.3683556 20.7402338"></polygon>
                                            <polygon id="Path-3" fill="url(#linearGradient-2)" opacity="0.1" points="101.428699 0 83.0667527 94.1480575 130.378721 47.0740288"></polygon>
                                        </g>
                                    </g>
                                </g>
                            </svg>
                        ...
                        <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5">
                                <img class="img-fluid" src="@yield('auth-image', asset('vuexy/app-assets/images/pages/login-v2.svg'))" alt="@yield('auth-image-alt', 'Authentication Illustration')">
                            </div>
                        </div>
                        <!-- /Left Text-->
                        <!-- Content-->
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <h2 class="card-title fw-bold mb-1">@yield('auth-title', __('Welcome!'))</h2>
                                <p class="card-text mb-2">@yield('auth-subtitle', __('Please proceed with the requested action.'))</p>
                                @yield('auth-content')
                                @hasSection('auth-extra')
                                    <div class="mt-2">
                                        @yield('auth-extra')
                                    </div>
                                @endif
